...
public class C03_GetRequest_ResponseData_AutomationTesting {
    @Test
    public void test02() {
        ...
        ve content type'inin application/json; charset=utf-8, ve Server isimli
        Header'in degerinin Cowboy, ve status Line' in HTTP/1.1 200 0K
        oldugunu test edin
        */
