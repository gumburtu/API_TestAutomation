...
public class C08_GetResponseBodyTest02 {
    @Test
    public void test01() {
        /*
        ...
        "userId":10,
        donen Response' un, status code' unun 201, ve content type'inin application/json|
        ...
        */
        ...
        requestBody.put("body", "API ogrenmek ah ne hos");
